    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.hirshfeld_model is not None:
            ...
            hirsh_volrat=None #RJM TODO is this every used again? should this be self.hirs_volrat
        self.dftdisp=self.hirsh_volrat #RJM TODO is this really necessary?
    ...
    def calculate(self, atoms=None, properties=["energy"], system_changes=all_changes):
        ...
        if self.calculation_required(atoms, properties):
            ...
            if self.model_hirshfeld is not None:
                ...
                if "hirsh_volrat" not in hirshfeld_model_results.keys():
                    raise SpkVdwCalculatorError(
                       "Your model does not support hirshfeld volume rations. Please check the model"
                       )
                hirshfeld = hirshfeld_model_results["hirsh_volrat"].cpu().data.numpy()
